...
CONTEXT_SETTINGS = dict(auto_envvar_prefix='sga_iot_sub')
...
class sgaIotSubCLI(click.MultiCommand):
    ...
    def get_command(self, ctx, name):
        try:
            ...
            mod = __import__('sga_iot_sub.commands.' + name,
                             None, None, ['command'])
...
@click.command(cls=sgaIotSubCLI, context_settings=CONTEXT_SETTINGS)
